...
- implement ESM resolve hook and loadDependencyCruiser for improved module resolution ([fc6f1d9](https://github.com/versatiles-org/node-release-tool/commit/fc6f1d979157989e02cad5fcd6755c8bd2084e83))

## [2.14.0] - 2026-09-17

### Features

- add treemap command to render and output treemap SVGs ([7964292](https://github.com/versatiles-org/node-release-tool/commit/796429207b4a48e026fc2d280be224214602e852))
